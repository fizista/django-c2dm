...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AndroidDeviceMessageChannels.last_change'
        db.alter_column('django_c2dm_androiddevicemessagechannels', 'last_change', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'AndroidDeviceMessageChannels.last_change'
        db.alter_column('django_c2dm_androiddevicemessagechannels', 'last_change', self.gf('django.db.models.fields.DateTimeField')())
