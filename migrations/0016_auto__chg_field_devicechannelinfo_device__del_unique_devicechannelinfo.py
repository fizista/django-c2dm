...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DeviceChannelInfo', fields ['device']
        #db.delete_unique('django_c2dm_devicechannelinfo', ['device_id'])


        # Changing field 'DeviceChannelInfo.device'
        db.alter_column('django_c2dm_devicechannelinfo', 'device_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_c2dm.AndroidDevice']))

    def backwards(self, orm):

        # Changing field 'DeviceChannelInfo.device'
        db.alter_column('django_c2dm_devicechannelinfo', 'device_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_c2dm.AndroidDevice'], unique=True))
        # Adding unique constraint on 'DeviceChannelInfo', fields ['device']
        #db.create_unique('django_c2dm_devicechannelinfo', ['device_id'])
