...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AndroidDeviceToken.registration_id'
        db.alter_column('django_c2dm_androiddevicetoken', 'registration_id', self.gf('django.db.models.fields.CharField')(max_length=140))

        # Changing field 'AndroidDevice.registration_id'
        db.alter_column('django_c2dm_androiddevice', 'registration_id', self.gf('django.db.models.fields.CharField')(max_length=140))
    ...
    models = {
        'django_c2dm.androiddevice': {
            ...
            'registration_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '180', 'blank': 'True'})
        },
        'django_c2dm.androiddevicetoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'registration_id': ('django.db.models.fields.CharField', [], {'max_length': '180'}),
