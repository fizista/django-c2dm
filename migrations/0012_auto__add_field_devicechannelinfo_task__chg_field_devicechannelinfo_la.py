...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceChannelInfo.task'
        db.add_column('django_c2dm_devicechannelinfo', 'task',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'DeviceChannelInfo.last_message'
        db.alter_column('django_c2dm_devicechannelinfo', 'last_message', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'DeviceChannelInfo.task'
        db.delete_column('django_c2dm_devicechannelinfo', 'task')


        # Changing field 'DeviceChannelInfo.last_message'
        db.alter_column('django_c2dm_devicechannelinfo', 'last_message', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
